...
| BR-041: Weather risk, weather data, scoring, advisory, and weather configuration rules apply. | CTMS-105-T01, CTMS-105-T02 | Tests and review evidence must prove this rule is enforced for `Compare Weather Risk Results with Manual Assessment`. |
| BR-042: Weather risk, weather data, scoring, advisory, and weather configuration rules apply. | CTMS-105-T01, CTMS-105-T02 | Tests and review evidence must prove this rule is enforced for `Compare Weather Risk Results with Manual Assessment`. |
| BR-043: Weather risk, weather data, scoring, advisory, and weather configuration rules apply. | CTMS-105-T01, CTMS-105-T02 | Tests and review evidence must prove this rule is enforced for `Compare Weather Risk Results with Manual Assessment`. |
| BR-044: Weather risk, weather data, scoring, advisory, and weather configuration rules apply. | CTMS-105-T01, CTMS-105-T02 | Tests and review evidence must prove this rule is enforced for `Compare Weather Risk Results with Manual Assessment`. |
| BR-045: Weather risk, weather data, scoring, advisory, and weather configuration rules apply. | CTMS-105-T01, CTMS-105-T02 | Tests and review evidence must prove this rule is enforced for `Compare Weather Risk Results with Manual Assessment`. |
