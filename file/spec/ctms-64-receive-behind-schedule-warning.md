# CTMS-64 - Receive Behind-Schedule Warning

**Spec Reference**  
/file/spec/ctms-64-receive-behind-schedule-warning.md

**Story Title**  
Receive Behind-Schedule Warning

**Status**  
To Do

**Story**  
As a Camper, I want to receive Behind-Schedule Warning so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Receive Behind-Schedule Warning` workflow when all Product Backlog V3 preconditions are satisfied.
...
- Priority: `Could Have`; Story points: `8`; Commitment: `Stretch`.
...
- CTMS-64-T01 [BE / Shared Logic] Implement `Receive Behind-Schedule Warning` for this task scope and enforce mapped business rules: BR-226. Ref: /file/spec/ctms-64-receive-behind-schedule-warning.md#backend-preparation-logic-and-tests
- CTMS-64-T02 [UI Web/Mobile/Consumer] Implement `Receive Behind-Schedule Warning` for this task scope and enforce mapped business rules: BR-226. Ref: /file/spec/ctms-64-receive-behind-schedule-warning.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Receive Behind-Schedule Warning` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-64-T01, CTMS-64-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Receive Behind-Schedule Warning` workflow exactly within `EPIC 10. GPS Navigation and Route Deviation`.
...
- Epic: `EPIC 10. GPS Navigation and Route Deviation`
- Sprint: `Sprint 4`
- Dependencies: `CTMS-61`
- Linked items: `Blocked by: CTMS-61
Blocks: CTMS-91`
- Spec Reference: `/file/spec/ctms-64-receive-behind-schedule-warning.md`
