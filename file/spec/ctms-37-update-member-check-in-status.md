# CTMS-37 - Update Member Check-In Status
...
**Story**  
As a Host, I want to update Member Check-In Status so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Update Member Check-In Status` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-37-T01 [BE / Shared Logic] Implement `Update Member Check-In Status` for this task scope and enforce mapped business rules: BR-112, BR-113, BR-114, BR-115. Ref: /file/spec/ctms-37-update-member-check-in-status.md#backend-preparation-logic-and-tests
- CTMS-37-T02 [UI Web/Mobile/Consumer] Implement `Update Member Check-In Status` for this task scope and enforce mapped business rules: BR-112, BR-113, BR-114, BR-115. Ref: /file/spec/ctms-37-update-member-check-in-status.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Update Member Check-In Status` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-37-T01, CTMS-37-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Update Member Check-In Status` workflow exactly within `EPIC 6. Booking and Payment`.
...
- Epic: `EPIC 6. Booking and Payment`
- Sprint: `Sprint 3`
- Dependencies: `CTMS-30`, `CTMS-31`
- Linked items: `Blocked by: CTMS-30, CTMS-31
Blocks: CTMS-38, CTMS-41`
- Spec Reference: `/file/spec/ctms-37-update-member-check-in-status.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-112, BR-113, BR-114, BR-115
