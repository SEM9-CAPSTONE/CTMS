# CTMS-87 - Update Trip Availability in Real Time

**Spec Reference**  
/file/spec/ctms-87-update-trip-availability-in-real-time.md

**Story Title**  
Update Trip Availability in Real Time

**Status**  
To Do

**Story**  
As a Camper, I want to update Trip Availability in Real Time so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Update Trip Availability in Real Time` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-87-T01 [BE / Shared Logic] Implement `Update Trip Availability in Real Time` for this task scope and enforce mapped business rules: BR-197, BR-198. Ref: /file/spec/ctms-87-update-trip-availability-in-real-time.md#backend-preparation-logic-and-tests
- CTMS-87-T02 [UI Web/Mobile/Consumer] Implement `Update Trip Availability in Real Time` for this task scope and enforce mapped business rules: BR-197, BR-198. Ref: /file/spec/ctms-87-update-trip-availability-in-real-time.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Update Trip Availability in Real Time` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-87-T01, CTMS-87-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Update Trip Availability in Real Time` workflow exactly within `EPIC 14. Real-Time Communication`.
...
- Epic: `EPIC 14. Real-Time Communication`
- Sprint: `Sprint 5`
- Dependencies: `CTMS-29`, `CTMS-24`, `CTMS-82`
- Linked items: `Blocked by: CTMS-29, CTMS-24, CTMS-82
Blocks: None`
- Spec Reference: `/file/spec/ctms-87-update-trip-availability-in-real-time.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-197, BR-198
