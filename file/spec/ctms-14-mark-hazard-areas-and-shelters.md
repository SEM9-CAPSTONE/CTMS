# CTMS-14 - Mark Hazard Areas and Shelters

**Spec Reference**  
/file/spec/ctms-14-mark-hazard-areas-and-shelters.md

**Story Title**  
Mark Hazard Areas and Shelters

**Status**  
To Do

**Story**  
As a Host, I want to mark Hazard Areas and Shelters so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Mark Hazard Areas and Shelters` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-14-T01 [BE / Shared Logic] Implement `Mark Hazard Areas and Shelters` for this task scope and enforce mapped business rules: BR-034, BR-035, BR-036. Ref: /file/spec/ctms-14-mark-hazard-areas-and-shelters.md#backend-preparation-logic-and-tests
- CTMS-14-T02 [UI Web/Mobile/Consumer] Implement `Mark Hazard Areas and Shelters` for this task scope and enforce mapped business rules: BR-034, BR-035, BR-036. Ref: /file/spec/ctms-14-mark-hazard-areas-and-shelters.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Mark Hazard Areas and Shelters` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-14-T01, CTMS-14-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Mark Hazard Areas and Shelters` workflow exactly within `EPIC 3. Trekking Route and Checkpoint Management`.
...
Blocks: CTMS-52`
- Spec Reference: `/file/spec/ctms-14-mark-hazard-areas-and-shelters.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-034, BR-035, BR-036
