# CTMS-22 - Configure Trip Waypoints
...
**Story**  
As a Host, I want to configure Trip Waypoints so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Configure Trip Waypoints` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-22-T01 [BE / Shared Logic] Implement `Configure Trip Waypoints` for this task scope and enforce mapped business rules: BR-058, BR-059, BR-060, BR-061, BR-062, BR-221. Ref: /file/spec/ctms-22-configure-trip-waypoints.md#backend-preparation-logic-and-tests
- CTMS-22-T02 [UI Web/Mobile/Consumer] Implement `Configure Trip Waypoints` for this task scope and enforce mapped business rules: BR-058, BR-059, BR-060, BR-061, BR-062, BR-221. Ref: /file/spec/ctms-22-configure-trip-waypoints.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Configure Trip Waypoints` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-22-T01, CTMS-22-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Trip waypoint handling must remain unified under the V3 `trip_waypoints` structure and must not reintroduce retired dedicated stop specs.

## Functional and Domain Requirements
- Implement the `Configure Trip Waypoints` workflow exactly within `EPIC 5. Trip Management`.
...
Blocks: CTMS-23, CTMS-27`
- Spec Reference: `/file/spec/ctms-22-configure-trip-waypoints.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-058, BR-059, BR-060, BR-061, BR-062, BR-221
