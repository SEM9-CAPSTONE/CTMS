# CTMS-34 - Cancel Booking According to Policy

**Spec Reference**  
/file/spec/ctms-34-cancel-booking-according-to-policy.md

**Story Title**  
Cancel Booking According to Policy

**Status**  
To Do

**Story**  
As a Camper, I want to cancel Booking According to Policy so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Cancel Booking According to Policy` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-34-T01 [BE / Shared Logic] Implement `Cancel Booking According to Policy` for this task scope and enforce mapped business rules: BR-100, BR-101, BR-102, BR-103, BR-104. Ref: /file/spec/ctms-34-cancel-booking-according-to-policy.md#backend-preparation-logic-and-tests
- CTMS-34-T02 [UI Web/Mobile/Consumer] Implement `Cancel Booking According to Policy` for this task scope and enforce mapped business rules: BR-100, BR-101, BR-102, BR-103, BR-104. Ref: /file/spec/ctms-34-cancel-booking-according-to-policy.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Cancel Booking According to Policy` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-34-T01, CTMS-34-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Cancel Booking According to Policy` workflow exactly within `EPIC 6. Booking and Payment`.
...
Blocks: CTMS-35, CTMS-107`
- Spec Reference: `/file/spec/ctms-34-cancel-booking-according-to-policy.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-100, BR-101, BR-102, BR-103, BR-104
