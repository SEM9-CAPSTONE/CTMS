# CTMS-45 - Request Porter for Trip

**Spec Reference**  
/file/spec/ctms-45-request-porter-for-trip.md

**Story Title**  
Request Porter for Trip

**Status**  
To Do

**Story**  
As a Host, I want to request Porter for Trip so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Request Porter for Trip` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-45-T01 [BE / Shared Logic] Implement `Request Porter for Trip` for this task scope and enforce mapped business rules: BR-145, BR-146, BR-147, BR-148. Ref: /file/spec/ctms-45-request-porter-for-trip.md#backend-preparation-logic-and-tests
- CTMS-45-T02 [UI Web/Mobile/Consumer] Implement `Request Porter for Trip` for this task scope and enforce mapped business rules: BR-145, BR-146, BR-147, BR-148. Ref: /file/spec/ctms-45-request-porter-for-trip.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Request Porter for Trip` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-45-T01, CTMS-45-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Request Porter for Trip` workflow exactly within `EPIC 8. Porter Management`.
...
- Epic: `EPIC 8. Porter Management`
- Sprint: `Sprint 3`
- Dependencies: `CTMS-21`, `CTMS-43`, `CTMS-44`
- Linked items: `Blocked by: CTMS-21, CTMS-43, CTMS-44
Blocks: CTMS-46`
- Spec Reference: `/file/spec/ctms-45-request-porter-for-trip.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-145, BR-146, BR-147, BR-148
