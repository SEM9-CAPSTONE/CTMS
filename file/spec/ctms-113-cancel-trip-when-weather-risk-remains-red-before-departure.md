# CTMS-113 - Cancel Trip When Weather Risk Remains Red Before Departure

**Spec Reference**  
/file/spec/ctms-113-cancel-trip-when-weather-risk-remains-red-before-departure.md

**Story Title**  
Cancel Trip When Weather Risk Remains Red Before Departure

**Status**  
To Do

**Story**  
As a Host, I want to cancel Trip When Weather Risk Remains Red Before Departure so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Cancel Trip When Weather Risk Remains Red Before Departure` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-113-T01 [BE / Shared Logic] Implement `Cancel Trip When Weather Risk Remains Red Before Departure` for this task scope and enforce mapped business rules: BR-048. Ref: /file/spec/ctms-113-cancel-trip-when-weather-risk-remains-red-before-departure.md#backend-preparation-logic-and-tests
- CTMS-113-T02 [UI Web/Mobile/Consumer] Implement `Cancel Trip When Weather Risk Remains Red Before Departure` for this task scope and enforce mapped business rules: BR-048. Ref: /file/spec/ctms-113-cancel-trip-when-weather-risk-remains-red-before-departure.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Cancel Trip When Weather Risk Remains Red Before Departure` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-113-T01, CTMS-113-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Cancel Trip When Weather Risk Remains Red Before Departure` workflow exactly within `EPIC 4. Weather Risk Assessment`.
...
- Epic: `EPIC 4. Weather Risk Assessment`
- Sprint: `Sprint 5`
- Dependencies: `CTMS-16`, `CTMS-23`, `CTMS-32`, `CTMS-35`
- Linked items: `Blocked by: CTMS-16, CTMS-23, CTMS-32, CTMS-35
Blocks: None`
- Spec Reference: `/file/spec/ctms-113-cancel-trip-when-weather-risk-remains-red-before-departure.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-048
