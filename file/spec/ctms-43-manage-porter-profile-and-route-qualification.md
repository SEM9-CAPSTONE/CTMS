# CTMS-43 - Manage Porter Profile and Route Qualification

**Spec Reference**  
/file/spec/ctms-43-manage-porter-profile-and-route-qualification.md

**Story Title**  
Manage Porter Profile and Route Qualification

**Status**  
To Do

**Story**  
As a Porter, I want to manage Porter Profile and Route Qualification so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Manage Porter Profile and Route Qualification` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-43-T01 [BE / Shared Logic] Implement `Manage Porter Profile and Route Qualification` for this task scope and enforce mapped business rules: BR-141, BR-142, BR-154, BR-155, BR-156, BR-157. Ref: /file/spec/ctms-43-manage-porter-profile-and-route-qualification.md#backend-preparation-logic-and-tests
- CTMS-43-T02 [UI Web/Mobile/Consumer] Implement `Manage Porter Profile and Route Qualification` for this task scope and enforce mapped business rules: BR-141, BR-142, BR-154, BR-155, BR-156, BR-157. Ref: /file/spec/ctms-43-manage-porter-profile-and-route-qualification.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Manage Porter Profile and Route Qualification` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-43-T01, CTMS-43-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Manage Porter Profile and Route Qualification` workflow exactly within `EPIC 8. Porter Management`.
...
- Story-level business rules: BR-141, BR-142, BR-154, BR-155, BR-156, BR-157
