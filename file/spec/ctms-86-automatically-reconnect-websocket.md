# CTMS-86 - Automatically Reconnect WebSocket

**Spec Reference**  
/file/spec/ctms-86-automatically-reconnect-websocket.md
...
**Story**  
As the System, I want to automatically Reconnect WebSocket so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Automatically Reconnect WebSocket` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-86-T01 [BE / Shared Logic] Implement `Automatically Reconnect WebSocket` for this task scope and enforce mapped business rules: BR-197, BR-201, BR-228. Ref: /file/spec/ctms-86-automatically-reconnect-websocket.md#backend-preparation-logic-and-tests
- CTMS-86-T02 [UI Web/Mobile/Consumer] Implement `Automatically Reconnect WebSocket` for this task scope and enforce mapped business rules: BR-197, BR-201, BR-228. Ref: /file/spec/ctms-86-automatically-reconnect-websocket.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Automatically Reconnect WebSocket` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-86-T01, CTMS-86-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Automatically Reconnect WebSocket` workflow exactly within `EPIC 14. Real-Time Communication`.
...
Blocks: None`
- Spec Reference: `/file/spec/ctms-86-automatically-reconnect-websocket.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-197, BR-201, BR-228
