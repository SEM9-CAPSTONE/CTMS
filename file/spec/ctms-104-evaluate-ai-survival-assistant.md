# CTMS-104 - Evaluate AI Survival Assistant

**Spec Reference**  
/file/spec/ctms-104-evaluate-ai-survival-assistant.md

**Story Title**  
Evaluate AI Survival Assistant

**Status**  
To Do

**Story**  
As the System, I want to evaluate AI Survival Assistant so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Evaluate AI Survival Assistant` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-104-T01 [BE / Shared Logic] Implement `Evaluate AI Survival Assistant` for this task scope and enforce mapped business rules: BR-219, BR-230, BR-231. Ref: /file/spec/ctms-104-evaluate-ai-survival-assistant.md#backend-preparation-logic-and-tests
- CTMS-104-T02 [UI Web/Mobile/Consumer] Implement `Evaluate AI Survival Assistant` for this task scope and enforce mapped business rules: BR-219, BR-230, BR-231. Ref: /file/spec/ctms-104-evaluate-ai-survival-assistant.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Evaluate AI Survival Assistant` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-104-T01, CTMS-104-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Evaluate AI Survival Assistant` workflow exactly within `EPIC 18. Reports and Evaluation Metrics`.
...
- Epic: `EPIC 18. Reports and Evaluation Metrics`
- Sprint: `Sprint 5`
- Dependencies: `CTMS-72`, `CTMS-71`, `CTMS-73`
- Linked items: `Blocked by: CTMS-72, CTMS-71, CTMS-73
Blocks: None`
- Spec Reference: `/file/spec/ctms-104-evaluate-ai-survival-assistant.md`
