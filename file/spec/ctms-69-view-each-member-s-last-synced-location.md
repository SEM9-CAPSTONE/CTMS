# CTMS-69 - View Each Member's Last Synced Location

**Spec Reference**  
/file/spec/ctms-69-view-each-member-s-last-synced-location.md

**Story Title**  
View Each Member's Last Synced Location

**Status**  
To Do

**Story**  
As a Host, I want to view Each Member's Last Synced Location so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `View Each Member's Last Synced Location` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-69-T01 [BE / Shared Logic] Implement `View Each Member's Last Synced Location` for this task scope and enforce mapped business rules: BR-210, BR-229. Ref: /file/spec/ctms-69-view-each-member-s-last-synced-location.md#backend-preparation-logic-and-tests
- CTMS-69-T02 [UI Web/Mobile/Consumer] Implement `View Each Member's Last Synced Location` for this task scope and enforce mapped business rules: BR-210, BR-229. Ref: /file/spec/ctms-69-view-each-member-s-last-synced-location.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `View Each Member's Last Synced Location` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-69-T01, CTMS-69-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `View Each Member's Last Synced Location` workflow exactly within `EPIC 11. Buffer and Synchronization`.
...
Blocks: CTMS-89`
- Spec Reference: `/file/spec/ctms-69-view-each-member-s-last-synced-location.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-210, BR-229
