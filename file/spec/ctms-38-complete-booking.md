...
**Story**  
As a Host, I want to complete Booking so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Complete Booking` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-38-T01 [BE / Shared Logic] Implement `Complete Booking` for this task scope and enforce mapped business rules: BR-117, BR-118. Ref: /file/spec/ctms-38-complete-booking.md#backend-preparation-logic-and-tests
- CTMS-38-T02 [UI Web/Mobile/Consumer] Implement `Complete Booking` for this task scope and enforce mapped business rules: BR-117, BR-118. Ref: /file/spec/ctms-38-complete-booking.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Complete Booking` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-38-T01, CTMS-38-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Epic: `EPIC 6. Booking and Payment`
- Sprint: `Sprint 3`
- Dependencies: `CTMS-37`, `CTMS-56`
- Linked items: `Blocked by: CTMS-37, CTMS-56
Blocks: CTMS-98, CTMS-99, CTMS-107, CTMS-119`
- Spec Reference: `/file/spec/ctms-38-complete-booking.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-117, BR-118
