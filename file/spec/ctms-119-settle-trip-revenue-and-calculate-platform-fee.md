# CTMS-119 - Settle Trip Revenue and Calculate Platform Fee

**Spec Reference**  
/file/spec/ctms-119-settle-trip-revenue-and-calculate-platform-fee.md

**Story Title**  
Settle Trip Revenue and Calculate Platform Fee

**Status**  
To Do

**Story**  
As a user, I want to settle Trip Revenue and Calculate Platform Fee so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Settle Trip Revenue and Calculate Platform Fee` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-119-T01 [BE / Shared Logic] Implement `Settle Trip Revenue and Calculate Platform Fee` for this task scope and enforce mapped business rules: BR-108, BR-181, BR-194. Ref: /file/spec/ctms-119-settle-trip-revenue-and-calculate-platform-fee.md#backend-preparation-logic-and-tests
- CTMS-119-T02 [UI Web/Mobile/Consumer] Implement `Settle Trip Revenue and Calculate Platform Fee` for this task scope and enforce mapped business rules: BR-108, BR-181, BR-194. Ref: /file/spec/ctms-119-settle-trip-revenue-and-calculate-platform-fee.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Settle Trip Revenue and Calculate Platform Fee` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-119-T01, CTMS-119-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Settle Trip Revenue and Calculate Platform Fee` workflow exactly within `EPIC 6. Booking and Payment`.
...
- Epic: `EPIC 6. Booking and Payment`
- Sprint: `Sprint 5`
- Dependencies: `CTMS-118`, `CTMS-35`, `CTMS-38`, `CTMS-56`
- Linked items: `Blocked by: CTMS-118, CTMS-35, CTMS-38, CTMS-56
Blocks: CTMS-117, CTMS-120, CTMS-121`
- Spec Reference: `/file/spec/ctms-119-settle-trip-revenue-and-calculate-platform-fee.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-108, BR-181, BR-194
