# CTMS-117 - View Host Revenue Analytics by Time and Area

**Spec Reference**  
/file/spec/ctms-117-view-host-revenue-analytics-by-time-and-area.md

**Story Title**  
View Host Revenue Analytics by Time and Area

**Status**  
To Do

**Story**  
As a Host, I want to view Host Revenue Analytics by Time and Area so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `View Host Revenue Analytics by Time and Area` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-117-T01 [BE / Shared Logic] Implement `View Host Revenue Analytics by Time and Area` for this task scope and enforce mapped business rules: BR-204. Ref: /file/spec/ctms-117-view-host-revenue-analytics-by-time-and-area.md#backend-preparation-logic-and-tests
- CTMS-117-T02 [UI Web/Mobile/Consumer] Implement `View Host Revenue Analytics by Time and Area` for this task scope and enforce mapped business rules: BR-204. Ref: /file/spec/ctms-117-view-host-revenue-analytics-by-time-and-area.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `View Host Revenue Analytics by Time and Area` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-117-T01, CTMS-117-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `View Host Revenue Analytics by Time and Area` workflow exactly within `EPIC 18. Reports and Evaluation Metrics`.
...
- Epic: `EPIC 18. Reports and Evaluation Metrics`
- Sprint: `Sprint 5`
- Dependencies: `CTMS-32`, `CTMS-35`, `CTMS-119`, `CTMS-120`
- Linked items: `Blocked by: CTMS-32, CTMS-35, CTMS-119, CTMS-120
Blocks: None`
- Spec Reference: `/file/spec/ctms-117-view-host-revenue-analytics-by-time-and-area.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-204
