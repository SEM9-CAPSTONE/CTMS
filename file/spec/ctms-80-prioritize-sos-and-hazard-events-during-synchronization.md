# CTMS-80 - Prioritize SOS and Hazard Events during Synchronization

**Spec Reference**  
/file/spec/ctms-80-prioritize-sos-and-hazard-events-during-synchronization.md

**Story Title**  
Prioritize SOS and Hazard Events during Synchronization

**Status**  
To Do

**Story**  
As the System, I want to prioritize SOS and Hazard Events during Synchronization so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Prioritize SOS and Hazard Events during Synchronization` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-80-T01 [BE / Shared Logic] Implement `Prioritize SOS and Hazard Events during Synchronization` for this task scope and enforce mapped business rules: BR-210, BR-224. Ref: /file/spec/ctms-80-prioritize-sos-and-hazard-events-during-synchronization.md#backend-preparation-logic-and-tests
- CTMS-80-T02 [UI Web/Mobile/Consumer] Implement `Prioritize SOS and Hazard Events during Synchronization` for this task scope and enforce mapped business rules: BR-210, BR-224. Ref: /file/spec/ctms-80-prioritize-sos-and-hazard-events-during-synchronization.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Prioritize SOS and Hazard Events during Synchronization` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-80-T01, CTMS-80-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Prioritize SOS and Hazard Events during Synchronization` workflow exactly within `EPIC 11. Buffer and Synchronization`.
...
- Epic: `EPIC 11. Buffer and Synchronization`
- Sprint: `Sprint 5`
- Dependencies: `CTMS-66`, `CTMS-79`
- Linked items: `Blocked by: CTMS-66, CTMS-79
Blocks: None`
- Spec Reference: `/file/spec/ctms-80-prioritize-sos-and-hazard-events-during-synchronization.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-210, BR-224
