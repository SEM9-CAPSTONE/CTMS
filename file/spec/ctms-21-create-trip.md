...
## Acceptance Criteria
- [ ] The intended actor can complete the `Create Trip` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-21-T01 [BE / Shared Logic] Implement `Create Trip` for this task scope and enforce mapped business rules: BR-055, BR-056, BR-057. Ref: /file/spec/ctms-21-create-trip.md#backend-preparation-logic-and-tests
- CTMS-21-T02 [UI Web/Mobile/Consumer] Implement `Create Trip` for this task scope and enforce mapped business rules: BR-055, BR-056, BR-057. Ref: /file/spec/ctms-21-create-trip.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Create Trip` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-21-T01, CTMS-21-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Story-level business rules: BR-055, BR-056, BR-057
