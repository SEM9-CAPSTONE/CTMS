# CTMS-49 - Report Incident during Trip
...
## Acceptance Criteria
- [ ] The intended actor can complete the `Report Incident during Trip` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-49-T01 [BE / Shared Logic] Implement `Report Incident during Trip` for this task scope and enforce mapped business rules: BR-163, BR-164, BR-224. Ref: /file/spec/ctms-49-report-incident-during-trip.md#backend-preparation-logic-and-tests
- CTMS-49-T02 [UI Web/Mobile/Consumer] Implement `Report Incident during Trip` for this task scope and enforce mapped business rules: BR-163, BR-164, BR-224. Ref: /file/spec/ctms-49-report-incident-during-trip.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Report Incident during Trip` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-49-T01, CTMS-49-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
Blocks: CTMS-92`
- Spec Reference: `/file/spec/ctms-49-report-incident-during-trip.md`
