# CTMS-12 - Close or Reopen Route Based on Conditions

**Spec Reference**  
/file/spec/ctms-12-close-or-reopen-route-based-on-conditions.md

**Story Title**  
Close or Reopen Route Based on Conditions

**Status**  
To Do

**Story**  
As a Host, I want to close or Reopen Route Based on Conditions so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Close or Reopen Route Based on Conditions` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-12-T01 [BE / Shared Logic] Implement `Close or Reopen Route Based on Conditions` for this task scope and enforce mapped business rules: BR-029, BR-030, BR-032, BR-033. Ref: /file/spec/ctms-12-close-or-reopen-route-based-on-conditions.md#backend-preparation-logic-and-tests
- CTMS-12-T02 [UI Web/Mobile/Consumer] Implement `Close or Reopen Route Based on Conditions` for this task scope and enforce mapped business rules: BR-029, BR-030, BR-032, BR-033. Ref: /file/spec/ctms-12-close-or-reopen-route-based-on-conditions.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Close or Reopen Route Based on Conditions` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-12-T01, CTMS-12-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Close or Reopen Route Based on Conditions` workflow exactly within `EPIC 3. Trekking Route and Checkpoint Management`.
...
- Epic: `EPIC 3. Trekking Route and Checkpoint Management`
- Sprint: `Sprint 2`
- Dependencies: `CTMS-13`
- Linked items: `Blocked by: CTMS-13
Blocks: None`
- Spec Reference: `/file/spec/ctms-12-close-or-reopen-route-based-on-conditions.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-029, BR-030, BR-032, BR-033
