# CTMS-89 - View Active Trekking Trips on Map

**Spec Reference**  
/file/spec/ctms-89-view-active-trekking-trips-on-map.md

**Story Title**  
View Active Trekking Trips on Map

**Status**  
To Do

**Story**  
As a Host, I want to view Active Trekking Trips on Map so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `View Active Trekking Trips on Map` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-89-T01 [BE / Shared Logic] Implement `View Active Trekking Trips on Map` for this task scope and enforce mapped business rules: BR-204, BR-224, BR-228. Ref: /file/spec/ctms-89-view-active-trekking-trips-on-map.md#backend-preparation-logic-and-tests
- CTMS-89-T02 [UI Web/Mobile/Consumer] Implement `View Active Trekking Trips on Map` for this task scope and enforce mapped business rules: BR-204, BR-224, BR-228. Ref: /file/spec/ctms-89-view-active-trekking-trips-on-map.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `View Active Trekking Trips on Map` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-89-T01, CTMS-89-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `View Active Trekking Trips on Map` workflow exactly within `EPIC 15. Host Monitoring Dashboard`.
...
- Epic: `EPIC 15. Host Monitoring Dashboard`
- Sprint: `Sprint 5`
- Dependencies: `CTMS-10`, `CTMS-11`, `CTMS-69`
- Linked items: `Blocked by: CTMS-10, CTMS-11, CTMS-69
Blocks: CTMS-90, CTMS-91, CTMS-93`
- Spec Reference: `/file/spec/ctms-89-view-active-trekking-trips-on-map.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-204, BR-224, BR-228
