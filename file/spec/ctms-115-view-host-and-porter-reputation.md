# CTMS-115 - View Host and Porter Reputation

**Spec Reference**  
/file/spec/ctms-115-view-host-and-porter-reputation.md

**Story Title**  
View Host and Porter Reputation

**Status**  
To Do

**Story**  
As a Host, I want to view Host and Porter Reputation so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `View Host and Porter Reputation` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-115-T01 [BE / Shared Logic] Implement `View Host and Porter Reputation` for this task scope and enforce mapped business rules: BR-119, BR-204. Ref: /file/spec/ctms-115-view-host-and-porter-reputation.md#backend-preparation-logic-and-tests
- CTMS-115-T02 [UI Web/Mobile/Consumer] Implement `View Host and Porter Reputation` for this task scope and enforce mapped business rules: BR-119, BR-204. Ref: /file/spec/ctms-115-view-host-and-porter-reputation.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `View Host and Porter Reputation` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-115-T01, CTMS-115-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `View Host and Porter Reputation` workflow exactly within `EPIC 17. Reviews and Feedback`.
...
- Epic: `EPIC 17. Reviews and Feedback`
- Sprint: `Sprint 5`
- Dependencies: `CTMS-98`, `CTMS-99`, `CTMS-114`
- Linked items: `Blocked by: CTMS-98, CTMS-99, CTMS-114
Blocks: None`
- Spec Reference: `/file/spec/ctms-115-view-host-and-porter-reputation.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-119, BR-204
