# CTMS-33 - Automatically Expire Booking
...
## Acceptance Criteria
- [ ] The intended actor can complete the `Automatically Expire Booking` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-33-T01 [BE / Shared Logic] Implement `Automatically Expire Booking` for this task scope and enforce mapped business rules: BR-095, BR-096, BR-097, BR-098, BR-099, BR-208, BR-209. Ref: /file/spec/ctms-33-automatically-expire-booking.md#backend-preparation-logic-and-tests
- CTMS-33-T02 [UI Web/Mobile/Consumer] Implement `Automatically Expire Booking` for this task scope and enforce mapped business rules: BR-095, BR-096, BR-097, BR-098, BR-099, BR-208, BR-209. Ref: /file/spec/ctms-33-automatically-expire-booking.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Automatically Expire Booking` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-33-T01, CTMS-33-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Epic: `EPIC 6. Booking and Payment`
- Sprint: `Sprint 3`
- Dependencies: `CTMS-29`, `CTMS-32`
- Linked items: `Blocked by: CTMS-29, CTMS-32
Blocks: None`
- Spec Reference: `/file/spec/ctms-33-automatically-expire-booking.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-095, BR-096, BR-097, BR-098, BR-099, BR-208, BR-209
