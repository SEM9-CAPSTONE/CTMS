# CTMS-40 - Add Services and Equipment Rental to Booking

**Spec Reference**  
/file/spec/ctms-40-add-services-and-equipment-rental-to-booking.md

**Story Title**  
Add Services and Equipment Rental to Booking

**Status**  
To Do

**Story**  
As a Camper, I want to add Services and Equipment Rental to Booking so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Add Services and Equipment Rental to Booking` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-40-T01 [BE / Shared Logic] Implement `Add Services and Equipment Rental to Booking` for this task scope and enforce mapped business rules: BR-123, BR-124, BR-125, BR-129, BR-130, BR-131. Ref: /file/spec/ctms-40-add-services-and-equipment-rental-to-booking.md#backend-preparation-logic-and-tests
- CTMS-40-T02 [UI Web/Mobile/Consumer] Implement `Add Services and Equipment Rental to Booking` for this task scope and enforce mapped business rules: BR-123, BR-124, BR-125, BR-129, BR-130, BR-131. Ref: /file/spec/ctms-40-add-services-and-equipment-rental-to-booking.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Add Services and Equipment Rental to Booking` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-40-T01, CTMS-40-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Add Services and Equipment Rental to Booking` workflow exactly within `EPIC 7. Equipment and Logistics`.
...
- Epic: `EPIC 7. Equipment and Logistics`
- Sprint: `Sprint 3`
- Dependencies: `CTMS-29`, `CTMS-39`
- Linked items: `Blocked by: CTMS-29, CTMS-39
Blocks: CTMS-41`
- Spec Reference: `/file/spec/ctms-40-add-services-and-equipment-rental-to-booking.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-123, BR-124, BR-125, BR-129, BR-130, BR-131
