# CTMS-72 - Ask AI about First Aid and Survival

**Spec Reference**  
/file/spec/ctms-72-ask-ai-about-first-aid-and-survival.md

**Story Title**  
Ask AI about First Aid and Survival

**Status**  
To Do

**Story**  
As a Camper, I want to ask AI about First Aid and Survival so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Ask AI about First Aid and Survival` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-72-T01 [BE / Shared Logic] Implement `Ask AI about First Aid and Survival` for this task scope and enforce mapped business rules: BR-219. Ref: /file/spec/ctms-72-ask-ai-about-first-aid-and-survival.md#backend-preparation-logic-and-tests
- CTMS-72-T02 [UI Web/Mobile/Consumer] Implement `Ask AI about First Aid and Survival` for this task scope and enforce mapped business rules: BR-219. Ref: /file/spec/ctms-72-ask-ai-about-first-aid-and-survival.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Ask AI about First Aid and Survival` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-72-T01, CTMS-72-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Ask AI about First Aid and Survival` workflow exactly within `EPIC 12. AI Survival Assistant and RAG`.
...
- Epic: `EPIC 12. AI Survival Assistant and RAG`
- Sprint: `Sprint 5`
- Dependencies: `CTMS-71`
- Linked items: `Blocked by: CTMS-71
Blocks: CTMS-74, CTMS-75, CTMS-78, CTMS-104`
- Spec Reference: `/file/spec/ctms-72-ask-ai-about-first-aid-and-survival.md`
