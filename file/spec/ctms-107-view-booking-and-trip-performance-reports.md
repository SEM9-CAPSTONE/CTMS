# CTMS-107 - View Booking and Trip Performance Reports

**Spec Reference**  
/file/spec/ctms-107-view-booking-and-trip-performance-reports.md

**Story Title**  
View Booking and Trip Performance Reports

**Status**  
To Do

**Story**  
As an Admin, I want to view Booking and Trip Performance Reports so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `View Booking and Trip Performance Reports` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-107-T01 [BE / Shared Logic] Implement `View Booking and Trip Performance Reports` for this task scope and enforce mapped business rules: BR-204. Ref: /file/spec/ctms-107-view-booking-and-trip-performance-reports.md#backend-preparation-logic-and-tests
- CTMS-107-T02 [UI Web/Mobile/Consumer] Implement `View Booking and Trip Performance Reports` for this task scope and enforce mapped business rules: BR-204. Ref: /file/spec/ctms-107-view-booking-and-trip-performance-reports.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `View Booking and Trip Performance Reports` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-107-T01, CTMS-107-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `View Booking and Trip Performance Reports` workflow exactly within `EPIC 18. Reports and Evaluation Metrics`.
...
- Epic: `EPIC 18. Reports and Evaluation Metrics`
- Sprint: `Sprint 5`
- Dependencies: `CTMS-29`, `CTMS-34`, `CTMS-38`
- Linked items: `Blocked by: CTMS-29, CTMS-34, CTMS-38
Blocks: None`
- Spec Reference: `/file/spec/ctms-107-view-booking-and-trip-performance-reports.md`
