# CTMS-39 - Manage Simple Equipment Catalog

**Spec Reference**  
/file/spec/ctms-39-manage-simple-equipment-catalog.md

**Story Title**  
Manage Simple Equipment Catalog

**Status**  
To Do

**Story**  
As a Host, I want to manage Simple Equipment Catalog so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Manage Simple Equipment Catalog` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-39-T01 [BE / Shared Logic] Implement `Manage Simple Equipment Catalog` for this task scope and enforce mapped business rules: BR-126, BR-127, BR-128. Ref: /file/spec/ctms-39-manage-simple-equipment-catalog.md#backend-preparation-logic-and-tests
- CTMS-39-T02 [UI Web/Mobile/Consumer] Implement `Manage Simple Equipment Catalog` for this task scope and enforce mapped business rules: BR-126, BR-127, BR-128. Ref: /file/spec/ctms-39-manage-simple-equipment-catalog.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Manage Simple Equipment Catalog` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-39-T01, CTMS-39-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Manage Simple Equipment Catalog` workflow exactly within `EPIC 7. Equipment and Logistics`.
...
Blocks: CTMS-40`
- Spec Reference: `/file/spec/ctms-39-manage-simple-equipment-catalog.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-126, BR-127, BR-128
