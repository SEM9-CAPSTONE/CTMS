...
**Story**  
As a Camper, I want to pay for Booking so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Pay for Booking` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-32-T01 [BE / Shared Logic] Implement `Pay for Booking` for this task scope and enforce mapped business rules: BR-092, BR-093, BR-094, BR-108, BR-181. Ref: /file/spec/ctms-32-pay-for-booking.md#backend-preparation-logic-and-tests
- CTMS-32-T02 [UI Web/Mobile/Consumer] Implement `Pay for Booking` for this task scope and enforce mapped business rules: BR-092, BR-093, BR-094, BR-108, BR-181. Ref: /file/spec/ctms-32-pay-for-booking.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Pay for Booking` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-32-T01, CTMS-32-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
Blocks: CTMS-33, CTMS-35, CTMS-36, CTMS-52, CTMS-113, CTMS-117, CTMS-118`
- Spec Reference: `/file/spec/ctms-32-pay-for-booking.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-092, BR-093, BR-094, BR-108, BR-181
