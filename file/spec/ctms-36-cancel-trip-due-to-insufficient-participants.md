# CTMS-36 - Cancel Trip Due to Insufficient Participants

**Spec Reference**  
/file/spec/ctms-36-cancel-trip-due-to-insufficient-participants.md

**Story Title**  
Cancel Trip Due to Insufficient Participants

**Status**  
To Do

**Story**  
As the System, I want to cancel Trip Due to Insufficient Participants so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Cancel Trip Due to Insufficient Participants` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-36-T01 [BE / Shared Logic] Implement `Cancel Trip Due to Insufficient Participants` for this task scope and enforce mapped business rules: BR-109, BR-110, BR-111. Ref: /file/spec/ctms-36-cancel-trip-due-to-insufficient-participants.md#backend-preparation-logic-and-tests
- CTMS-36-T02 [UI Web/Mobile/Consumer] Implement `Cancel Trip Due to Insufficient Participants` for this task scope and enforce mapped business rules: BR-109, BR-110, BR-111. Ref: /file/spec/ctms-36-cancel-trip-due-to-insufficient-participants.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Cancel Trip Due to Insufficient Participants` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-36-T01, CTMS-36-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Cancel Trip Due to Insufficient Participants` workflow exactly within `EPIC 5. Trip Management`.
...
- Epic: `EPIC 5. Trip Management`
- Sprint: `Sprint 3`
- Dependencies: `CTMS-23`, `CTMS-32`, `CTMS-35`
- Linked items: `Blocked by: CTMS-23, CTMS-32, CTMS-35
Blocks: None`
- Spec Reference: `/file/spec/ctms-36-cancel-trip-due-to-insufficient-participants.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-109, BR-110, BR-111
