# CTMS-121 - Reconcile Refund after Settlement or Payout

**Spec Reference**  
/file/spec/ctms-121-reconcile-refund-after-settlement-or-payout.md

**Story Title**  
Reconcile Refund after Settlement or Payout

**Status**  
To Do

**Story**  
As an Admin, I want to reconcile Refund after Settlement or Payout so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Reconcile Refund after Settlement or Payout` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-121-T01 [BE / Shared Logic] Implement `Reconcile Refund after Settlement or Payout` for this task scope and enforce mapped business rules: BR-105, BR-106, BR-107, BR-108, BR-181. Ref: /file/spec/ctms-121-reconcile-refund-after-settlement-or-payout.md#backend-preparation-logic-and-tests
- CTMS-121-T02 [UI Web/Mobile/Consumer] Implement `Reconcile Refund after Settlement or Payout` for this task scope and enforce mapped business rules: BR-105, BR-106, BR-107, BR-108, BR-181. Ref: /file/spec/ctms-121-reconcile-refund-after-settlement-or-payout.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Reconcile Refund after Settlement or Payout` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-121-T01, CTMS-121-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Reconcile Refund after Settlement or Payout` workflow exactly within `EPIC 6. Booking and Payment`.
...
- Epic: `EPIC 6. Booking and Payment`
- Sprint: `Sprint 5`
- Dependencies: `CTMS-35`, `CTMS-119`, `CTMS-120`
- Linked items: `Blocked by: CTMS-35, CTMS-119, CTMS-120
Blocks: None`
- Spec Reference: `/file/spec/ctms-121-reconcile-refund-after-settlement-or-payout.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-105, BR-106, BR-107, BR-108, BR-181
