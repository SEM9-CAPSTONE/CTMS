# CTMS-118 - Hold Successful Booking Funds

**Spec Reference**  
/file/spec/ctms-118-hold-successful-booking-funds.md

**Story Title**  
Hold Successful Booking Funds

**Status**  
To Do

**Story**  
As a user, I want to hold Successful Booking Funds so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Hold Successful Booking Funds` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-118-T01 [BE / Shared Logic] Implement `Hold Successful Booking Funds` for this task scope and enforce mapped business rules: BR-092, BR-093, BR-094. Ref: /file/spec/ctms-118-hold-successful-booking-funds.md#backend-preparation-logic-and-tests
- CTMS-118-T02 [UI Web/Mobile/Consumer] Implement `Hold Successful Booking Funds` for this task scope and enforce mapped business rules: BR-092, BR-093, BR-094. Ref: /file/spec/ctms-118-hold-successful-booking-funds.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Hold Successful Booking Funds` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-118-T01, CTMS-118-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Hold Successful Booking Funds` workflow exactly within `EPIC 6. Booking and Payment`.
...
Blocks: CTMS-119`
- Spec Reference: `/file/spec/ctms-118-hold-successful-booking-funds.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-092, BR-093, BR-094
