...
**Spec Reference**  
/file/spec/ctms-93-view-overview-of-bookings-routes-porters-and-alerts.md

**Story Title**  
View Overview of Bookings, Routes, Porters, and Alerts

**Status**  
To Do

**Story**  
As a Host, I want to view Overview of Bookings, Routes, Porters, and Alerts so that the CTMS workflow is completed safely, consistently, and within the correct business scope.
...
- CTMS-93-T01 [BE / Shared Logic] Implement `View Overview of Bookings, Routes, Porters, and Alerts` for this task scope and enforce mapped business rules: BR-204, BR-228. Ref: /file/spec/ctms-93-view-overview-of-bookings-routes-porters-and-alerts.md#backend-preparation-logic-and-tests
- CTMS-93-T02 [UI Web/Mobile/Consumer] Implement `View Overview of Bookings, Routes, Porters, and Alerts` for this task scope and enforce mapped business rules: BR-204, BR-228. Ref: /file/spec/ctms-93-view-overview-of-bookings-routes-porters-and-alerts.md#ui-and-tests
...
- Implement the `View Overview of Bookings, Routes, Porters, and Alerts` workflow exactly within `EPIC 15. Host Monitoring Dashboard`.
...
- Story-level business rules: BR-204, BR-228
