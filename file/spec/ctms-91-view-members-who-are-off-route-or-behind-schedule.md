# CTMS-91 - View Members Who Are Off-Route or Behind Schedule

**Spec Reference**  
/file/spec/ctms-91-view-members-who-are-off-route-or-behind-schedule.md

**Story Title**  
View Members Who Are Off-Route or Behind Schedule

**Status**  
To Do

**Story**  
As a Host, I want to view Members Who Are Off-Route or Behind Schedule so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `View Members Who Are Off-Route or Behind Schedule` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-91-T01 [BE / Shared Logic] Implement `View Members Who Are Off-Route or Behind Schedule` for this task scope and enforce mapped business rules: BR-220, BR-226, BR-228. Ref: /file/spec/ctms-91-view-members-who-are-off-route-or-behind-schedule.md#backend-preparation-logic-and-tests
- CTMS-91-T02 [UI Web/Mobile/Consumer] Implement `View Members Who Are Off-Route or Behind Schedule` for this task scope and enforce mapped business rules: BR-220, BR-226, BR-228. Ref: /file/spec/ctms-91-view-members-who-are-off-route-or-behind-schedule.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `View Members Who Are Off-Route or Behind Schedule` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-91-T01, CTMS-91-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `View Members Who Are Off-Route or Behind Schedule` workflow exactly within `EPIC 15. Host Monitoring Dashboard`.
...
- Epic: `EPIC 15. Host Monitoring Dashboard`
- Sprint: `Sprint 5`
- Dependencies: `CTMS-60`, `CTMS-64`, `CTMS-89`
- Linked items: `Blocked by: CTMS-60, CTMS-64, CTMS-89
Blocks: None`
- Spec Reference: `/file/spec/ctms-91-view-members-who-are-off-route-or-behind-schedule.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-220, BR-226, BR-228
