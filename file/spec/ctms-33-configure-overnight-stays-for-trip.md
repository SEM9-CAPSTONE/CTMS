...
**Story Title**  
Configure Overnight Stays for Trip

**Status**  
To Do

**Story**  
As a Host, I want to configure Overnight Stays for Trip so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] Each night has night_number, stay_date, zone_id, and tents_needed.
- [ ] night_number and stay_date cannot duplicate within the same Trip.
- [ ] row count equals duration_nights.
...
| --- | --- | --- |
| AC1: Each night has night_number, stay_date, zone_id, and tents_needed | CTMS-33-T01, CTMS-33-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
| AC2: night_number and stay_date cannot duplicate within the same Trip | CTMS-33-T01, CTMS-33-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
