...
- [ ] BR-162: Porter profile, availability, request, response, qualification, and assignment rules apply.
...
- CTMS-48-T01 [BE / Shared Logic] Implement `View Assigned Trips` for this task scope and enforce mapped business rules: BR-162. Ref: /file/spec/ctms-48-view-assigned-trips.md#backend-preparation-logic-and-tests
- CTMS-48-T02 [UI Web/Mobile/Consumer] Implement `View Assigned Trips` for this task scope and enforce mapped business rules: BR-162. Ref: /file/spec/ctms-48-view-assigned-trips.md#ui-and-tests
...
| BR-162: Porter profile, availability, request, response, qualification, and assignment rules apply. | CTMS-48-T01, CTMS-48-T02 | Tests and review evidence must prove this rule is enforced for `View Assigned Trips`. |
...
- Story-level business rules: BR-162
