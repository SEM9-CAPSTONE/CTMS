...
**Spec Reference**  
/file/spec/ctms-99-review-porter-after-trip.md

**Story Title**  
Review Porter after Trip

**Status**  
To Do

**Story**  
As a Camper, I want to review Porter after Trip so that the CTMS workflow is completed safely, consistently, and within the correct business scope.
...
- CTMS-99-T01 [BE / Shared Logic] Implement `Review Porter after Trip` for this task scope and enforce mapped business rules: BR-119. Ref: /file/spec/ctms-99-review-porter-after-trip.md#backend-preparation-logic-and-tests
- CTMS-99-T02 [UI Web/Mobile/Consumer] Implement `Review Porter after Trip` for this task scope and enforce mapped business rules: BR-119. Ref: /file/spec/ctms-99-review-porter-after-trip.md#ui-and-tests
...
| BR-119: Review, feedback, and reputation rules apply. | CTMS-99-T01, CTMS-99-T02 | Tests and review evidence must prove this rule is enforced for `Review Porter after Trip`. |
...
- Implement the `Review Porter after Trip` workflow exactly within `EPIC 17. Reviews and Feedback`.
