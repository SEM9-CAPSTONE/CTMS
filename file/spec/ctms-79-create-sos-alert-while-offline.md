# CTMS-79 - Create SOS Alert while Offline

**Spec Reference**  
/file/spec/ctms-79-create-sos-alert-while-offline.md

**Story Title**  
Create SOS Alert while Offline

**Status**  
To Do

**Story**  
As a user, I want to create SOS Alert while Offline so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Create SOS Alert while Offline` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-79-T01 [BE / Shared Logic] Implement `Create SOS Alert while Offline` for this task scope and enforce mapped business rules: BR-210, BR-224, BR-228, BR-229. Ref: /file/spec/ctms-79-create-sos-alert-while-offline.md#backend-preparation-logic-and-tests
- CTMS-79-T02 [UI Web/Mobile/Consumer] Implement `Create SOS Alert while Offline` for this task scope and enforce mapped business rules: BR-210, BR-224, BR-228, BR-229. Ref: /file/spec/ctms-79-create-sos-alert-while-offline.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Create SOS Alert while Offline` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-79-T01, CTMS-79-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Create SOS Alert while Offline` workflow exactly within `EPIC 13. SOS and Emergency Management`.
...
- Epic: `EPIC 13. SOS and Emergency Management`
- Sprint: `Sprint 5`
- Dependencies: `CTMS-77`, `CTMS-65`
- Linked items: `Blocked by: CTMS-77, CTMS-65
Blocks: CTMS-80`
- Spec Reference: `/file/spec/ctms-79-create-sos-alert-while-offline.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-210, BR-224, BR-228, BR-229
