# CTMS-19 - Generate Clear Weather Risk Advice Using LLM

**Spec Reference**  
/file/spec/ctms-19-generate-clear-weather-risk-advice-using-llm.md

**Story Title**  
Generate Clear Weather Risk Advice Using LLM

**Status**  
To Do

**Story**  
As the System, I want to generate Clear Weather Risk Advice Using LLM so that the CTMS workflow is completed safely, consistently, and within the correct business scope.

## Acceptance Criteria
- [ ] The intended actor can complete the `Generate Clear Weather Risk Advice Using LLM` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-19-T01 [BE / Shared Logic] Implement `Generate Clear Weather Risk Advice Using LLM` for this task scope and enforce mapped business rules: BR-050, BR-051, BR-219. Ref: /file/spec/ctms-19-generate-clear-weather-risk-advice-using-llm.md#backend-preparation-logic-and-tests
- CTMS-19-T02 [UI Web/Mobile/Consumer] Implement `Generate Clear Weather Risk Advice Using LLM` for this task scope and enforce mapped business rules: BR-050, BR-051, BR-219. Ref: /file/spec/ctms-19-generate-clear-weather-risk-advice-using-llm.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Generate Clear Weather Risk Advice Using LLM` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-19-T01, CTMS-19-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Implement the `Generate Clear Weather Risk Advice Using LLM` workflow exactly within `EPIC 4. Weather Risk Assessment`.
...
Blocks: None`
- Spec Reference: `/file/spec/ctms-19-generate-clear-weather-risk-advice-using-llm.md`
- Product Backlog source: `PRODUCT BACKLOG.xlsx`, sheet `version 3`
- Business Rules source: `CTMS- Business rules.xlsx`
- Story-level business rules: BR-050, BR-051, BR-219
