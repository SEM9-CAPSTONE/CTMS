...
## Acceptance Criteria
- [ ] The intended actor can complete the `Update Personal Profile and Emergency Contact` workflow when all Product Backlog V3 preconditions are satisfied.
...
- CTMS-07-T01 [BE / Shared Logic] Implement `Update Personal Profile and Emergency Contact` for this task scope and enforce mapped business rules: BR-020, BR-021, BR-022. Ref: /file/spec/ctms-07-update-personal-profile-and-emergency-contact.md#backend-preparation-logic-and-tests
- CTMS-07-T02 [UI Web/Mobile/Consumer] Implement `Update Personal Profile and Emergency Contact` for this task scope and enforce mapped business rules: BR-020, BR-021, BR-022. Ref: /file/spec/ctms-07-update-personal-profile-and-emergency-contact.md#ui-and-tests

## Task to Acceptance Criteria Traceability
| Acceptance criterion / business rule | Covered by tasks | Evidence expected |
| --- | --- | --- |
| AC1: The intended actor can complete the `Update Personal Profile and Emergency Contact` workflow when all Product Backlog V3 preconditions are satisfied. | CTMS-07-T01, CTMS-07-T02 | Unit, integration, API, UI, or E2E evidence depending on touched layer |
...
- Story-level business rules: BR-020, BR-021, BR-022
