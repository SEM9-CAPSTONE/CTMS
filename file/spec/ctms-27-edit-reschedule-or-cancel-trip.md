...
- [ ] BR-065: Trip creation, waypoint, approval, editing, and lifecycle rules apply.
- [ ] BR-078: Booking capacity, booking member, and seat reservation rules apply.
- [ ] BR-079: Booking capacity, booking member, and seat reservation rules apply.
- [ ] BR-080: Booking capacity, booking member, and seat reservation rules apply.
...
| BR-065: Trip creation, waypoint, approval, editing, and lifecycle rules apply. | CTMS-27-T01, CTMS-27-T02 | Tests and review evidence must prove this rule is enforced for `Edit, Reschedule, or Cancel Trip`. |
| BR-078: Booking capacity, booking member, and seat reservation rules apply. | CTMS-27-T01, CTMS-27-T02 | Tests and review evidence must prove this rule is enforced for `Edit, Reschedule, or Cancel Trip`. |
| BR-079: Booking capacity, booking member, and seat reservation rules apply. | CTMS-27-T01, CTMS-27-T02 | Tests and review evidence must prove this rule is enforced for `Edit, Reschedule, or Cancel Trip`. |
| BR-080: Booking capacity, booking member, and seat reservation rules apply. | CTMS-27-T01, CTMS-27-T02 | Tests and review evidence must prove this rule is enforced for `Edit, Reschedule, or Cancel Trip`. |
