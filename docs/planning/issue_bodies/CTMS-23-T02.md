## Parent Story
- External Story ID: `CTMS-23`
- Story title: Đánh dấu vùng nguy hiểm và nơi trú ẩn
- Epic: `ctms-epic-03`
- Sprint: `Sprint 2`

## Requirement
- Implement screen/form, loading states, empty states and user-facing errors.
- Acceptance Criteria: Các điểm được hiển thị trên bản đồ; được đưa vào offline package; có mô tả an toàn.
