## Parent Story
- External Story ID: `CTMS-106`
- Story title: Phân biệt dữ liệu real-time và last-seen
- Epic: `ctms-epic-15`
- Sprint: `Sprint 5`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Hiển thị rõ timestamp; màu Gray khi dữ liệu quá cũ; không gọi vị trí offline là real-time.
...
## Linked Items
- Blocked by: `CTMS-106-T01`
- Story dependency: `CTMS-105`
