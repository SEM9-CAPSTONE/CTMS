## Parent Story
- External Story ID: `CTMS-84`
- Story title: Xem vị trí đồng bộ gần nhất của từng thành viên
- Epic: `ctms-epic-11`
- Sprint: `Sprint 4`

## Requirement
- Implement screen/form, loading states, empty states and user-facing errors.
- Acceptance Criteria: Hiển thị vị trí, thời gian, pin, checkpoint cuối và “Last seen X minutes ago”.
