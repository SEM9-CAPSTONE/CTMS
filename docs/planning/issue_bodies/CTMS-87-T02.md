## Parent Story
- External Story ID: `CTMS-87`
- Story title: Sử dụng RAG
- Epic: `ctms-epic-12`
- Sprint: `Sprint 5`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: Truy xuất các chunk liên quan; ghi lại nguồn; không gửi context không liên quan vượt giới hạn.
...
## Linked Items
- Blocked by: `CTMS-87-T01`
- Story dependency: `CTMS-66`
