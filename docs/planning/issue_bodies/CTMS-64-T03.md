## Parent Story
- External Story ID: `CTMS-64`
- Story title: Báo cáo sự cố trong chuyến đi
- Epic: `ctms-epic-08`
- Sprint: `Sprint 3`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Có loại sự cố, mô tả, vị trí, ảnh tùy chọn; lưu offline nếu mất mạng.
...
## Linked Items
- Blocked by: `CTMS-64-T01`
- Story dependency: `CTMS-63`
