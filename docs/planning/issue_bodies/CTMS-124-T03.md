## Parent Story
- External Story ID: `CTMS-124`
- Story title: Quản lý tài khoản người dùng
- Epic: `ctms-epic-19`
- Sprint: `Sprint 1`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: Tìm kiếm, xem, khóa, mở khóa tài khoản; không xóa cứng dữ liệu liên quan.
