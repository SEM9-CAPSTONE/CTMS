## Parent Story
- External Story ID: `CTMS-03`
- Story title: Đăng nhập
- Epic: `ctms-epic-01`
- Sprint: `Sprint 1`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Đăng nhập đúng trả về access token và refresh token; đăng nhập sai hiển thị thông báo phù hợp; tài khoản bị khóa không được đăng nhập.
...
## Linked Items
- Blocked by: `CTMS-03-T01`
- Story dependency: `CTMS-02`
