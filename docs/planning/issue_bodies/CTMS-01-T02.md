## Parent Story
- External Story ID: `CTMS-01`
- Story title: Đăng ký tài khoản bằng email hoặc số điện thoại
- Epic: `ctms-epic-01`
- Sprint: `Sprint 1`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: Không cho phép trùng email hoặc số điện thoại; kiểm tra định dạng; mật khẩu được mã hóa; tài khoản được tạo thành công khi dữ liệu hợp lệ.
