## Parent Story
- External Story ID: `CTMS-49`
- Story title: Hoàn tất booking
- Epic: `ctms-epic-06`
- Sprint: `Sprint 3`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Cập nhật booking_members.member_status = left và left_at; booking chỉ chuyển status = completed khi Trip đã kết thúc và các thành viên đã được xử lý; kiểm tra thiết bị thuê đã trả hoặc ghi nhận chưa trả; sau đó cho phép đánh giá.
