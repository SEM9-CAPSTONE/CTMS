## Parent Story
- External Story ID: `CTMS-108`
- Story title: Quản lý sự cố trong chuyến
- Epic: `ctms-epic-15`
- Sprint: `Sprint 5`

## Requirement
- Implement screen/form, loading states, empty states and user-facing errors.
- Acceptance Criteria: Tạo incident; phân công xử lý; cập nhật trạng thái; lưu nhật ký hành động.
...
## Linked Items
- Blocked by: `CTMS-108-T01`
- Story dependency: `CTMS-64, CTMS-93`
