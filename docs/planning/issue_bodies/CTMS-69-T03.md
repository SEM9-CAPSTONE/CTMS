## Parent Story
- External Story ID: `CTMS-69`
- Story title: Hệ thống kiểm tra tính toàn vẹn của offline package
- Epic: `ctms-epic-09`
- Sprint: `Sprint 4`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Kiểm tra checksum; package không hợp lệ chuyển offline_packages.status = failed; cho phép tải lại; không sử dụng status corrupted vì enum offline_package_status không có giá trị này.
...
## Linked Items
- Blocked by: `CTMS-69-T01`
- Story dependency: `CTMS-68`
