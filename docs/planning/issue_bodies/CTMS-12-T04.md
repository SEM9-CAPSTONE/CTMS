## Parent Story
- External Story ID: `CTMS-12`
- Story title: Tạo các zone trong campsite
- Epic: `ctms-epic-02`
- Sprint: `Sprint 2`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Mỗi zone có tên, sức chứa, vị trí, giá cơ bản, tiện ích và trạng thái.
