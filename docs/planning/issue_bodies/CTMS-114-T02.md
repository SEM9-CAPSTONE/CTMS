## Parent Story
- External Story ID: `CTMS-114`
- Story title: Đánh giá campsite, Trip hoặc route
- Epic: `ctms-epic-17`
- Sprint: `Post-defense`

## Requirement
- Implement screen/form, loading states, empty states and user-facing errors.
- Acceptance Criteria: Chỉ booking có status = completed được đánh giá; mỗi reviewer chỉ đánh giá một target trong một booking một lần; target_type chỉ nhận campsite, trip hoặc route; rating hợp lệ và có thể kèm bình luận.
...
## Linked Items
- Blocked by: `CTMS-114-T01`
- Story dependency: `CTMS-49`
