## Parent Story
- External Story ID: `CTMS-109`
- Story title: Xem tổng quan booking, route, Porter và cảnh báo
- Epic: `ctms-epic-15`
- Sprint: `Sprint 5`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: Dashboard hiển thị KPI chính, booking hôm nay, trip active, SOS và weather risk.
...
## Linked Items
- Blocked by: `CTMS-109-T01`
- Story dependency: `CTMS-42, CTMS-62, CTMS-26, CTMS-93, CTMS-105`
