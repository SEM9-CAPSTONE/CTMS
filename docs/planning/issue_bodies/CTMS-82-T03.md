## Parent Story
- External Story ID: `CTMS-82`
- Story title: Chống gửi trùng GPS log
- Epic: `ctms-epic-11`
- Sprint: `Sprint 4`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Mỗi log có idempotency key; server bỏ qua log đã nhận; không tạo bản ghi trùng.
