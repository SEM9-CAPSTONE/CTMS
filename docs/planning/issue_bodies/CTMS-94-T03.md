## Parent Story
- External Story ID: `CTMS-94`
- Story title: Nhận diện câu hỏi khẩn cấp
- Epic: `ctms-epic-12`
- Sprint: `Sprint 5`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Nhận diện từ khóa nguy hiểm; trả lời ngắn gọn; hiển thị nút SOS và vị trí hiện tại.
...
## Linked Items
- Blocked by: `CTMS-94-T01`
- Story dependency: `CTMS-88, CTMS-93`
