## Parent Story
- External Story ID: `CTMS-80`
- Story title: Lưu GPS log cục bộ khi mất mạng
- Epic: `ctms-epic-11`
- Sprint: `Sprint 4`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: GPS log được lưu vào local database; không mất dữ liệu khi đóng hoặc khởi động lại ứng dụng.
...
## Linked Items
- Blocked by: `CTMS-80-T01`
- Story dependency: `CTMS-74`
