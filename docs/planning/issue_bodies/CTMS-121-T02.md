## Parent Story
- External Story ID: `CTMS-121`
- Story title: So sánh Weather Risk với đánh giá thủ công
- Epic: `ctms-epic-18`
- Sprint: `Post-defense`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: Có bộ test case; tính mức độ trùng khớp; ghi nhận false warning và missed risk.
