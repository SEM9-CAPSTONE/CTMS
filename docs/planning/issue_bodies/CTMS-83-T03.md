## Parent Story
- External Story ID: `CTMS-83`
- Story title: Thử lại khi đồng bộ thất bại
- Epic: `ctms-epic-11`
- Sprint: `Sprint 4`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Áp dụng exponential backoff; giới hạn số lần thử; không chặn thao tác của người dùng.
