## Parent Story
- External Story ID: `CTMS-29`
- Story title: LLM diễn giải Weather Risk thành lời khuyên rõ ràng
- Epic: `ctms-epic-04`
- Sprint: `Post-defense`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: LLM chỉ diễn giải dữ liệu đầu vào; không tự sửa risk score; câu trả lời có hành động cụ thể.
