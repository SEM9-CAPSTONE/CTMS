## Parent Story
- External Story ID: `CTMS-45`
- Story title: Hủy booking theo chính sách
- Epic: `ctms-epic-06`
- Sprint: `Sprint 3`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Tính phí hủy theo cancellation_policy_snapshot; cập nhật bookings.status = cancelled và cancelled_at; giảm seats_taken, giải phóng equipment_reservations còn hiệu lực; ghi booking_change_logs và lý do.
