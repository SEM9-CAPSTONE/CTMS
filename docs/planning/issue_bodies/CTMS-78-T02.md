## Parent Story
- External Story ID: `CTMS-78`
- Story title: Điều chỉnh tần suất GPS
- Epic: `ctms-epic-10`
- Sprint: `Sprint 4`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: Tần suất thay đổi theo trạng thái di chuyển, pin và mức nguy hiểm; không làm mất cảnh báo quan trọng.
