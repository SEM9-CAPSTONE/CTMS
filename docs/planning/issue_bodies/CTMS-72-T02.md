## Parent Story
- External Story ID: `CTMS-72`
- Story title: Được cảnh báo khi offline package đã cũ
- Epic: `ctms-epic-09`
- Sprint: `Sprint 4`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Hiển thị phiên bản và thời gian cập nhật; cảnh báo khi route, weather hoặc knowledge base có phiên bản mới.
