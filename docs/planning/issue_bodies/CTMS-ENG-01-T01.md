## Parent Story
- External Story ID: `CTMS-ENG-01`
- Story title: Engineering foundation
- Epic: `ctms-epic-00`
- Sprint: `Sprint 1`

## Requirement
- Verify completed foundation and attach evidence.
- Acceptance Criteria: Repository, branching convention, local/dev environment, migration, seed data, CI lint/build/test và smoke E2E framework đã hoàn thành từ 2026-07-26.
