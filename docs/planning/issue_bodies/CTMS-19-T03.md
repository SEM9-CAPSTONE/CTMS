## Parent Story
- External Story ID: `CTMS-19`
- Story title: Tạo trekking route trên bản đồ
- Epic: `ctms-epic-03`
- Sprint: `Sprint 2`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: Cho phép vẽ tuyến hoặc nhập GPX/GeoJSON; lưu độ dài, độ khó, thời gian dự kiến và trạng thái.
