## Parent Story
- External Story ID: `CTMS-05`
- Story title: Đặt lại mật khẩu khi quên mật khẩu
- Epic: `ctms-epic-01`
- Sprint: `Sprint 1`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Có OTP hoặc liên kết đặt lại; mật khẩu mới phải đúng quy tắc; phiên đăng nhập cũ bị thu hồi.
...
## Linked Items
- Blocked by: `CTMS-05-T01`
- Story dependency: `CTMS-01`
