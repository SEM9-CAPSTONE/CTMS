## Parent Story
- External Story ID: `CTMS-98`
- Story title: Thiết lập kết nối WebSocket có xác thực
- Epic: `ctms-epic-14`
- Sprint: `Sprint 5`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: Socket kiểm tra JWT; từ chối token sai hoặc hết hạn; người dùng tham gia đúng room.
