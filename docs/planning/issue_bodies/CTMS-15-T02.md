## Parent Story
- External Story ID: `CTMS-15`
- Story title: Quản lý hình ảnh campsite
- Epic: `ctms-epic-02`
- Sprint: `Sprint 2`

## Requirement
- Implement screen/form, loading states, empty states and user-facing errors.
- Acceptance Criteria: Cho phép thêm, xóa và sắp xếp ảnh; mỗi ảnh có URL, loại và thứ tự; chỉ Host sở hữu campsite được cập nhật.
...
## Linked Items
- Blocked by: `CTMS-15-T01`
- Story dependency: `CTMS-10`
