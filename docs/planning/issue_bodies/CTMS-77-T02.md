## Parent Story
- External Story ID: `CTMS-77`
- Story title: Biết hướng và khoảng cách quay lại tuyến
- Epic: `ctms-epic-10`
- Sprint: `Sprint 4`

## Requirement
- Implement screen/form, loading states, empty states and user-facing errors.
- Acceptance Criteria: Hiển thị điểm gần nhất trên route; khoảng cách; hướng di chuyển đề xuất.
