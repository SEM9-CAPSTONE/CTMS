## Parent Story
- External Story ID: `CTMS-02`
- Story title: Xác minh tài khoản bằng OTP hoặc email
- Epic: `ctms-epic-01`
- Sprint: `Sprint 1`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: OTP có thời hạn; giới hạn số lần gửi; không thể kích hoạt bằng OTP sai hoặc hết hạn.
