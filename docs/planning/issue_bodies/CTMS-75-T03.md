## Parent Story
- External Story ID: `CTMS-75`
- Story title: Được cảnh báo khi đi lệch tuyến
- Epic: `ctms-epic-10`
- Sprint: `Sprint 4`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: Tính khoảng cách tới route; chỉ cảnh báo sau nhiều mẫu liên tiếp; hỗ trợ rung, âm thanh và popup offline.
...
## Linked Items
- Blocked by: `CTMS-75-T01`
- Story dependency: `CTMS-73, CTMS-74`
