## Parent Story
- External Story ID: `CTMS-66`
- Story title: Chia tài liệu thành các knowledge chunk
- Epic: `ctms-epic-12`
- Sprint: `Sprint 4`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Chunk có nội dung, metadata, nguồn và phiên bản; có thể tạo embedding.
...
## Linked Items
- Blocked by: `CTMS-66-T01`
- Story dependency: `CTMS-65`
