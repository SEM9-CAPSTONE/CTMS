## Parent Story
- External Story ID: `CTMS-86`
- Story title: Chuyển dữ liệu GPS sang thiết bị Porter khi thiết bị tôi không có mạng
- Epic: `ctms-epic-11`
- Sprint: `Post-defense`

## Requirement
- Implement screen/form, loading states, empty states and user-facing errors.
- Acceptance Criteria: Truyền dữ liệu qua Bluetooth hoặc Wi-Fi Direct; xác thực trip; chống dữ liệu giả và dữ liệu trùng.
...
## Linked Items
- Blocked by: `CTMS-86-T01`
- Story dependency: `CTMS-80, CTMS-82, CTMS-60`
