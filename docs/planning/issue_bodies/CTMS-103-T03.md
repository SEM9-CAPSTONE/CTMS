## Parent Story
- External Story ID: `CTMS-103`
- Story title: Cập nhật số chỗ Trip theo thời gian thực
- Epic: `ctms-epic-14`
- Sprint: `Sprint 5`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Khi booking có status IN (confirmed, cancelled, expired), frontend nhận seats_taken và số chỗ còn lại mới; không hiển thị Locked/Released theo slot; sự kiện trùng phải được bỏ qua.
...
## Linked Items
- Blocked by: `CTMS-103-T01`
- Story dependency: `CTMS-40, CTMS-35, CTMS-98`
