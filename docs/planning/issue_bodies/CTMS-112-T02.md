## Parent Story
- External Story ID: `CTMS-112`
- Story title: Nhận push notification khi ứng dụng chạy nền
- Epic: `ctms-epic-16`
- Sprint: `Sprint 5`

## Requirement
- Implement screen/form, loading states, empty states and user-facing errors.
- Acceptance Criteria: Nhận booking update, Porter assignment, weather alert và SOS; không gửi trùng.
