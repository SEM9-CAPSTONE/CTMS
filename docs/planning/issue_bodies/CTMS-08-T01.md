## Parent Story
- External Story ID: `CTMS-08`
- Story title: Đăng xuất khỏi thiết bị hiện tại hoặc toàn bộ thiết bị
- Epic: `ctms-epic-01`
- Sprint: `Sprint 1`

## Requirement
- Implement API/service logic, persistence contract and authorization checks.
- Acceptance Criteria: Token hiện tại bị thu hồi; tùy chọn đăng xuất toàn bộ làm mất hiệu lực mọi refresh token.
