## Parent Story
- External Story ID: `CTMS-55`
- Story title: Ghi nhận thiết bị hỏng, mất hoặc đã hoàn trả
- Epic: `ctms-epic-07`
- Sprint: `Sprint 3`

## Requirement
- Implement screen/form, loading states, empty states and user-facing errors.
- Acceptance Criteria: Khi hoàn trả, cập nhật equipment_reservations.status = returned và thiết bị cụ thể về status = available nếu còn tốt; thiết bị hỏng chuyển equipment_items.status = maintenance và tạo equipment_damage_logs; thiết bị mất chuyển status = lost; quá hạn chưa trả chuyển reservation.status = not_returned.
...
## Linked Items
- Blocked by: `CTMS-55-T01`
- Story dependency: `CTMS-54`
