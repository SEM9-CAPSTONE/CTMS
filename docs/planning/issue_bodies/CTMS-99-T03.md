## Parent Story
- External Story ID: `CTMS-99`
- Story title: Nhận cảnh báo SOS theo thời gian thực
- Epic: `ctms-epic-13`
- Sprint: `Sprint 5`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: WebSocket gửi cảnh báo dưới 2 giây khi kết nối ổn định; có âm thanh và xác nhận đã nhận.
...
## Linked Items
- Blocked by: `CTMS-99-T01`
- Story dependency: `CTMS-93, CTMS-98`
