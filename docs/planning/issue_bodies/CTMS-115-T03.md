## Parent Story
- External Story ID: `CTMS-115`
- Story title: Đánh giá Porter sau chuyến đi
- Epic: `ctms-epic-17`
- Sprint: `Post-defense`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Chỉ thành viên chuyến được đánh giá; cập nhật điểm trung bình Porter.
...
## Linked Items
- Blocked by: `CTMS-115-T01`
- Story dependency: `CTMS-62, CTMS-49`
