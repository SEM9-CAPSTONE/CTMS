## Parent Story
- External Story ID: `CTMS-93`
- Story title: Gửi SOS khi gặp nguy hiểm
- Epic: `ctms-epic-13`
- Sprint: `Sprint 5`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Gửi người dùng, trip, vị trí, thời gian, pin và loại sự cố; nút dễ truy cập.
