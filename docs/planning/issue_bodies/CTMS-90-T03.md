## Parent Story
- External Story ID: `CTMS-90`
- Story title: Xem nguồn kiến thức của câu trả lời AI
- Epic: `ctms-epic-12`
- Sprint: `Sprint 5`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Hiển thị tên tài liệu hoặc danh mục tham chiếu; không tạo nguồn giả.
...
## Linked Items
- Blocked by: `CTMS-90-T01`
- Story dependency: `CTMS-88, CTMS-87`
