## Parent Story
- External Story ID: `CTMS-35`
- Story title: Ngăn vượt sức chứa Trip và zone
- Epic: `ctms-epic-05`
- Sprint: `Sprint 2`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: Tạo hoặc xác nhận booking được thực hiện trong transaction; khóa theo trip_id khi cập nhật seats_taken; khóa theo zone_id khi kiểm tra trip_camp_stays; tổng người không vượt capacity_max hoặc max_people và tổng lều không vượt max_tents; giao dịch xung đột phải rollback.
