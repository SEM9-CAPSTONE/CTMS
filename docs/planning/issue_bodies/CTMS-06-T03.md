## Parent Story
- External Story ID: `CTMS-06`
- Story title: Phân quyền theo Camper, Host, Porter và Admin
- Epic: `ctms-epic-01`
- Sprint: `Sprint 1`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: API kiểm tra quyền ở backend; người dùng không thể truy cập chức năng ngoài vai trò; thao tác trái phép trả về 403.
