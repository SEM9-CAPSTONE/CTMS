## Parent Story
- External Story ID: `CTMS-68`
- Story title: Tải offline package trước khi khởi hành
- Epic: `ctms-epic-09`
- Sprint: `Sprint 4`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Hiển thị dung lượng và tiến độ; tải tiếp tục sau gián đoạn; kiểm tra đủ bộ nhớ.
...
## Linked Items
- Blocked by: `CTMS-68-T01`
- Story dependency: `CTMS-67`
