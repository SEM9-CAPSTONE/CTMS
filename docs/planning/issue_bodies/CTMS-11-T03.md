## Parent Story
- External Story ID: `CTMS-11`
- Story title: Chỉnh sửa thông tin campsite
- Epic: `ctms-epic-02`
- Sprint: `Sprint 2`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: Chỉ Host sở hữu campsite được sửa; lưu lịch sử thay đổi; dữ liệu cập nhật hiển thị cho Camper.
