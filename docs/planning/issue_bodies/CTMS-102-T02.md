## Parent Story
- External Story ID: `CTMS-102`
- Story title: Tự động reconnect khi WebSocket bị ngắt
- Epic: `ctms-epic-14`
- Sprint: `Sprint 5`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: Tự kết nối lại; dùng backoff; khôi phục room; lấy sự kiện bị bỏ lỡ.
