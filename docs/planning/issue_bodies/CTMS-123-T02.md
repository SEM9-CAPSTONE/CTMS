## Parent Story
- External Story ID: `CTMS-123`
- Story title: Xem báo cáo booking và sử dụng Trip/zone
- Epic: `ctms-epic-18`
- Sprint: `Post-defense`

## Requirement
- Implement screen/form, loading states, empty states and user-facing errors.
- Acceptance Criteria: Lọc theo thời gian; hiển thị số booking, tỷ lệ lấp đầy Trip, số lều/người đã giữ theo zone và ngày, tỷ lệ hủy và doanh thu ước tính; không báo cáo theo campsite slot.
...
## Linked Items
- Blocked by: `CTMS-123-T01`
- Story dependency: `CTMS-33, CTMS-40, CTMS-45, CTMS-49`
