## Parent Story
- External Story ID: `CTMS-10`
- Story title: Tạo campsite
- Epic: `ctms-epic-02`
- Sprint: `Sprint 2`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Nhập tên, mô tả, tọa độ, tỉnh/thành, ảnh, chính sách và thời gian hoạt động; campsite được tạo ở trạng thái Draft; chỉ Host đã đăng nhập được tạo.
