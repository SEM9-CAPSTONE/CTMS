## Parent Story
- External Story ID: `CTMS-53`
- Story title: Thuê thiết bị cùng booking
- Epic: `ctms-epic-07`
- Sprint: `Sprint 3`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Chỉ hiển thị thiết bị còn tồn theo ngày; tính phí; không cho thuê vượt số lượng.
...
## Linked Items
- Blocked by: `CTMS-53-T01`
- Story dependency: `CTMS-52, CTMS-40`
