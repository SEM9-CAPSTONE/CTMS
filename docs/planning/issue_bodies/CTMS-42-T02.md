## Parent Story
- External Story ID: `CTMS-42`
- Story title: Xem chi tiết booking
- Epic: `ctms-epic-06`
- Sprint: `Sprint 2`

## Requirement
- Implement screen/form, loading states, empty states and user-facing errors.
- Acceptance Criteria: Hiển thị mã booking, Trip, route, thời gian, danh sách thành viên, giá, phụ phí, thiết bị thuê, payment_status và booking_status; không hiển thị campsite slot.
