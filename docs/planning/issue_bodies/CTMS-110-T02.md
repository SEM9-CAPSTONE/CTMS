## Parent Story
- External Story ID: `CTMS-110`
- Story title: Nhận thông báo trong ứng dụng
- Epic: `ctms-epic-16`
- Sprint: `Sprint 1`

## Requirement
- Implement validation, boundary handling, conflict handling and recoverable error behavior.
- Acceptance Criteria: Lưu notification; hiển thị trạng thái đọc hoặc chưa đọc; liên kết tới nội dung liên quan.
