## Parent Story
- External Story ID: `CTMS-85`
- Story title: Xem trạng thái đồng bộ dữ liệu trên thiết bị
- Epic: `ctms-epic-11`
- Sprint: `Sprint 4`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Hiển thị số log chờ gửi, lần đồng bộ cuối và lỗi nếu có; có nút thử lại.
