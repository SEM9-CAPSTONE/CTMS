## Parent Story
- External Story ID: `CTMS-28`
- Story title: Chặn đăng ký mới khi route ở mức Red
- Epic: `ctms-epic-04`
- Sprint: `Sprint 2`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Không tạo booking mới cho Trip/route có mức Red; hiển thị lý do và thời điểm đánh giá; không tạo Trip Member vì hệ thống sử dụng bookings và booking_members.
