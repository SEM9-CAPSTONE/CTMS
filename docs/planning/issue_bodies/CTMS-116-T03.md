## Parent Story
- External Story ID: `CTMS-116`
- Story title: Báo cáo thông tin sai hoặc nội dung nguy hiểm
- Epic: `ctms-epic-17`
- Sprint: `Post-defense`

## Requirement
- Wire integration where applicable and capture evidence for acceptance criteria.
- Acceptance Criteria: Chọn loại báo cáo; nhập mô tả; Admin xem được trạng thái xử lý.
