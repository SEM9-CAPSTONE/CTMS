...
- Name: refresh-session.spec.ts >> Refresh Authentication Session — Web Integration (E2E, real backend) >> collapses concurrent protected 401s into exactly one /auth/refresh call
- Location: tests\e2e\refresh-session.spec.ts:122:2
