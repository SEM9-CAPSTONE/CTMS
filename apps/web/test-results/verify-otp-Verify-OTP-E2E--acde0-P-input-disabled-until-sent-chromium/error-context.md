...
- Name: verify-otp.spec.ts >> Verify OTP (E2E, real backend) >> keeps the send button disabled until a channel is chosen, then keeps the OTP input disabled until sent
- Location: tests\e2e\verify-otp.spec.ts:103:2
...
- text: Email *
- img
- textbox "camper@example.com": e2e-verify-1786618581175-33674@example.com
- text: Số điện thoại *
- img
- textbox "0912345678": "0931610903"
