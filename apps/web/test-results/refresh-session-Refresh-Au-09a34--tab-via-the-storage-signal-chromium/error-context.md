...
- Name: refresh-session.spec.ts >> Refresh Authentication Session — Web Integration (E2E, real backend) >> propagates session invalidation to another tab via the storage signal
- Location: tests\e2e\refresh-session.spec.ts:188:2
