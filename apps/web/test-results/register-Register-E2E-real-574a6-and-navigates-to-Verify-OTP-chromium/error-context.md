...
- Name: register.spec.ts >> Register (E2E, real backend) >> registers successfully with email and phone and navigates to Verify OTP
- Location: tests\e2e\register.spec.ts:48:2
...
- text: Email *
- img
- textbox "camper@example.com": e2e-tc1-1786618578560@example.com
- text: Số điện thoại *
- img
- textbox "0912345678": "0962982534"
