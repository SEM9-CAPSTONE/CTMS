...
- Name: admin-user-accounts.spec.ts >> Admin user accounts >> searches, views, locks, and unlocks an account
- Location: tests\e2e\admin-user-accounts.spec.ts:26:2
...
Locator: getByRole('navigation', { name: 'Administration navigation' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('navigation', { name: 'Administration navigation' })
...
```ts
  ...
  3   | const admin = {
  4   | 	id: "admin-1",
  5   | 	email: "admin@ctms.local",
  6   | 	phone: null,
  7   | 	fullName: "CTMS Admin",
  8   | 	role: "admin",
  9   | 	roles: ["admin"],
  10  | 	status: "active",
  ...
  14  | const camperBase = {
  15  | 	id: "user-1",
  16  | 	email: "camper@example.com",
  17  | 	phone: "+84912345678",
  18  | 	fullName: "Nguyen Camper",
  19  | 	role: "camper",
  20  | 	roles: ["camper"],
