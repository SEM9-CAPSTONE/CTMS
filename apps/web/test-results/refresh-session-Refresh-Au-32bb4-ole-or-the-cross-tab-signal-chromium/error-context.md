...
- Name: refresh-session.spec.ts >> Refresh Authentication Session — Web Integration (E2E, real backend) >> rotates tokens end-to-end with no token leakage in requests, console, or the cross-tab signal
- Location: tests\e2e\refresh-session.spec.ts:227:2
